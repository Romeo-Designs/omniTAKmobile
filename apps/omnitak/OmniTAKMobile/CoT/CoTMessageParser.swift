...
class CoTMessageParser {
    ...
    static func parse(xml: String) -> CoTEventType? {
        ...
        } else if eventType == "t-x-takp-v" {
            // TAK Protocol Version message - log and ignore gracefully
            print("CoTMessageParser: Received TAK Protocol Version message (t-x-takp-v)")
            return nil
        } else if eventType == "t-x-d-d" {
            // Data Delete message - log and ignore gracefully
            print("CoTMessageParser: Received Data Delete message (t-x-d-d)")
            return nil
        }
