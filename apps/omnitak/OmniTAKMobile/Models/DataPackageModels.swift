...
struct PackageImportResult {
    ...
    var success: Bool
    var overlaysImported: Int
    var iconsImported: Int

    init(package: DataPackage, warnings: [String] = [], skippedFiles: [String] = [], success: Bool = true, overlaysImported: Int = 0, iconsImported: Int = 0) {
        self.package = package
        self.warnings = warnings
        self.skippedFiles = skippedFiles
        self.success = success
        self.overlaysImported = overlaysImported
        self.iconsImported = iconsImported
    }
}
...
// MARK: - Package Metadata Cache

struct PackageMetadataCache: Codable {
    let packageId: UUID
    let name: String
    let version: String
