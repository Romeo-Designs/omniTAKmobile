...
struct ATAKBottomToolbarWithFilters: View {
    ...
    private func activateMeasureTool() {
        // Post notification to activate measurement mode
        NotificationCenter.default.post(
            name: NSNotification.Name("ActivateMeasurementTool"),
            object: nil
        )
        print("📏 Measurement tool activated")
    }
    
    private func activateRouteTool() {
        // Post notification to activate route planning mode
        NotificationCenter.default.post(
            name: NSNotification.Name("ActivateRouteTool"),
            object: nil
        )
        print("🗺️ Route tool activated")
    }
}
