...
struct ATAKMapView: View {
    ...
    private func setupChatIntegration() {
        print("🔧 MapViewController.setupChatIntegration() - configuring ChatManager with takService instance: \(ObjectIdentifier(takService)), isConnected: \(takService.isConnected)")
        ...
        print("🔧 MapViewController.setupChatIntegration() - completed")
    }
