...
<event version="2.0" uid="GeoChat.SELF-123.msg-789" type="b-t-f" ...>
    <point lat="38.8977" lon="-77.0365" hae="50.0" ce="10.0" le="5.0"/>
    <detail>
        <__chat id="msg-789" chatroom="R-06" senderCallsign="OmniTAK-iOS" ...>
            <chatgrp uid0="SELF-123" uid1="R-06" id="R-06"/>
        </__chat>
        <link uid="SELF-123" type="a-f-G-E-S" .../>
        <remarks source="BAO.F.ATAK.SELF-123" to="R-06">Private message</remarks>
        <marti>
            <dest callsign="R-06"/>
        </marti>
    </detail>
