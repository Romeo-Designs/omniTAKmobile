...
3. **Clean build:**
   ```bash
   ./scripts/clean_build.sh --all //docs/modules/omnitak_mobile/android:omnitak_android
   ```
...
# Build all targets
bazel build //docs/modules/omnitak_mobile/...

# Run tests
bazel test //docs/modules/omnitak_mobile/...
```
...
- [OmniTAK Mobile BUILD_GUIDE.md](/docs/modules/omnitak_mobile/BUILD_GUIDE.md)
