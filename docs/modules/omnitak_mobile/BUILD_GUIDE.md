...
cp -R target/OmniTAKMobile.xcframework \
  $PROJECT_ROOT/docs/modules/omnitak_mobile/ios/native/
...
```bash
ls -la $PROJECT_ROOT/docs/modules/omnitak_mobile/ios/native/
...
mkdir -p $PROJECT_ROOT/docs/modules/omnitak_mobile/android/native/lib/{arm64-v8a,armeabi-v7a,x86_64,x86}

# Copy arm64-v8a
cp target/aarch64-linux-android/release/libomnitak_mobile.a \
   $PROJECT_ROOT/docs/modules/omnitak_mobile/android/native/lib/arm64-v8a/

# Copy armeabi-v7a
cp target/armv7-linux-androideabi/release/libomnitak_mobile.a \
   $PROJECT_ROOT/docs/modules/omnitak_mobile/android/native/lib/armeabi-v7a/

# Copy x86_64
cp target/x86_64-linux-android/release/libomnitak_mobile.a \
   $PROJECT_ROOT/docs/modules/omnitak_mobile/android/native/lib/x86_64/

# Copy x86
cp target/i686-linux-android/release/libomnitak_mobile.a \
   $PROJECT_ROOT/docs/modules/omnitak_mobile/android/native/lib/x86/
```

### Step 4: Verify Android Build

```bash
ls -la $PROJECT_ROOT/docs/modules/omnitak_mobile/android/native/
...
3. Navigate to `docs/modules/omnitak_mobile/ios/native/`
...
android {
    ...
    externalNativeBuild {
        cmake {
            path "../../docs/modules/omnitak_mobile/android/native/CMakeLists.txt"
            version "3.18.1"
        }
    }
    ...
    sourceSets {
        main {
            // Add Kotlin source
            java.srcDirs += '../../docs/modules/omnitak_mobile/android/native'
        }
    }
}
